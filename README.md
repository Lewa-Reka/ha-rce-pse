...
Projekt na licencji [GNU Affero General Public License w wersji 3 lub nowszej](https://spdx.org/licenses/AGPL-3.0-or-later.html) (SPDX: `AGPL-3.0-or-later`) – pełny tekst w pliku [LICENSE](LICENSE).
