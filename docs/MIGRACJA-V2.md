...
**Licencja:** od wersji 2.0.0 kod jest na [GNU Affero General Public License v3.0 lub nowszą](https://spdx.org/licenses/AGPL-3.0-or-later.html) (SPDX: `AGPL-3.0-or-later`). Wcześniejsze wydania były na Apache License 2.0. Pełny tekst licencji: plik [LICENSE](../LICENSE) w repozytorium.
