...
- **Dostępność danych "jutro":** ceny na następny dzień publikowane są przez PSE zazwyczaj po 14:00
...
- **PDGSZ (Godziny Szczytu / Energetyczny Kompas):** `\pdgsz` – prognoza użytkowania (`usage_fcst`) na godziny, zalecenia PSE co do użytkowania i oszczędzania energii. Pobierane są `business_date`, `dtime`, `is_active`, `usage_fcst`.
