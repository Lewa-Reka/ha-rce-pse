...
class RCEHighPriceThresholdWindowStartSensor(RCEHighPriceThresholdWindowSensor):

    def __init__(self, coordinator: RCEPSEDataUpdateCoordinator, config_entry: ConfigEntry) -> None:
        super().__init__(coordinator, config_entry, "high_price_threshold_window_start")
...
class RCEHighPriceThresholdWindowEndSensor(RCEHighPriceThresholdWindowSensor):

    def __init__(self, coordinator: RCEPSEDataUpdateCoordinator, config_entry: ConfigEntry) -> None:
        super().__init__(coordinator, config_entry, "high_price_threshold_window_end")
        self._attr_device_class = SensorDeviceClass.TIMESTAMP
